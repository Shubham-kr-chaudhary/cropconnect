...
export default function Profile() {
  ...
  // 1) Fetch user data & crops from /api/user/dashboard
  useEffect(() => {
    axios
      ...
      .then((res) => {
        setUser(res.data.user);     // user = { _id, name, email, role, ... }
        setCrops(res.data.crops);   // crops array
      })
  ...
  return (
    <div className="max-w-5xl mx-auto p-6 bg-gray-100 min-h-screen">
      ...
      {/* IF the user is a Firm, show Orders */}
      {user.role === "firm" && (
        <>
